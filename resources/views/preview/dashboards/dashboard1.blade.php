                                                ...
                                                <div class="card card-block card-stretch card-height card-bottom-border-primary note-detail">
                                                    ...
                                                    <div class="card-body rounded">
                                                        ...
                                                        <ul class="row mb-0 p-0 list-inline flex-wrap align-items-center">
                                                            <li class="col-4">
                                                                <a href="#">
                                                                    <img src="{{asset('images/gallery/grid/08.jpg')}}" class="img-fluid note-image rounded" alt="" />  
                                                                </a> 
                                                            </li>
                                                            <li class="col-4">
                                                                <a href="#">
                                                                    <img src="{{asset('images/gallery/grid/05.jpg')}}" class="img-fluid note-image rounded" alt="" />  
                                                                </a> 
                                                            </li>
                                                            <li class="col-4">
                                                                <a href="#">
                                                ...
                                                <div class="card card-block card-stretch card-height card-bottom-border-primary note-detail">
                                                    ...
                                                    <div class="card-body rounded">
                                                        ...
                                                        <ul class="row mb-0 p-0 list-inline flex-wrap align-items-center">
                                                            <li class="col-4">
                                                                <a href="#">
                                                                    <img src="{{asset('images/gallery/grid/01.jpg')}}" class="img-fluid rounded" alt="" />  
                                                                </a> 
                                                            </li>
                                                            <li class="col-4">
                                                                <a href="#">
                                                                    <img src="{{asset('images/gallery/grid/02.jpg')}}" class="img-fluid rounded" alt="" />  
                                                                </a> 
                                                            </li>
                                                            <li class="col-4">
                                                                <a href="#">
                                                                    <img src="{{asset('images/gallery/grid/03.jpg')}}" class="img-fluid rounded" alt="" />  
                                                                </a> 
                                                            </li>
                                                        </ul>
                                                    </div>
