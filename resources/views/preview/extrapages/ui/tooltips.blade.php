<x-app-layout>
   <div class="container-fluid ui-elements">
      <x-header headerTitle="Tooltip"></x-header>
         <div class="row">
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="collapse" id="tooltip-1">
                           <div class="card"><kbd class="bg-dark"><pre id="tooltips" class="text-white"><code>
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="collapse" id="tooltip-3">
                           <div class="card"><kbd class="bg-dark"><pre id="tooltips2" class="text-white"><code>
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="collapse" id="tooltip-4">
                           <div class="card"><kbd class="bg-dark"><pre id="tooltips3" class="text-white"><code>
