<x-app-layout>
   <div class="container-fluid">
      <x-header headerTitle="Card"></x-header>
         <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-3">
               <div class="card">
                  <img src={{URL::asset("images/page-img/07.jpg")}} class="card-img-top" alt="#">
                  <div class="card-body">
         ...
         <div class="row">
            ...
            <div class="col-md-6 col-lg-4 col-sm-6">
               <div class="card bg-dark text-white">
                  <img  src={{URL::asset("images/page-img/07.jpg")}} class="card-img" alt="#">
               ...
               <div class="card mb-2">
                  <div class="row no-gutters">
                     <div class="col-md-6 col-lg-4">
                        <img  src={{URL::asset("images/page-img/08.jpg")}} class="card-img" alt="#">
                     </div>
            ...
            <div class="col-md-6 col-lg-6">
               <div class="card">
                  <div class="row no-gutters flex-row-reverse">
                     <div class="col-md-6 col-lg-4">
                        <img  src={{URL::asset("images/page-img/09.jpg")}} class="card-img" alt="#">
                     </div>
                     <div class="col-md-6 col-lg-8">
