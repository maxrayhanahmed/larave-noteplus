<x-app-layout>
   <div class="container-fluid ui-elements">
      <x-header headerTitle="Popovers"></x-header>
         <div class="row">
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="collapse" id="popovers-1">
                           <div class="card"><kbd class="bg-dark"><pre id="popovers" class="text-white"><code>
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="collapse" id="popovers-2">
                           <div class="card"><kbd class="bg-dark"><pre id="dismiss-on-next-click" class="text-white"><code>
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="collapse" id="popovers-3">
                           <div class="card"><kbd class="bg-dark"><pre id="disabled-elements" class="text-white"><code>
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="collapse" id="popovers-4">
                           <div class="card"><kbd class="bg-dark"><pre id="hover-elements" class="text-white"><code>
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="collapse" id="popovers-5">
                           <div class="card"><kbd class="bg-dark"><pre id="four-directions" class="text-white"><code>
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="collapse" id="popovers-6">
                           <div class="card"><kbd class="bg-dark"><pre id="popovers-with-color" class="text-white"><code>
