        ...
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                ...
                <a href="../backend/index.html" class="header-logo">
                    {{-- {{#compare logoName '!==' ''}} --}}
                        {{-- <img src="{{path}}assets/images/{{logoName}}" class="img-fluid rounded-normal light-logo " alt="logo"> --}}
                    {{-- {{else}} --}}
                        <img src="{{asset('images/logo.png')}}" class="img-fluid rounded-normal light-logo" alt="logo">
                    {{-- {{/compare}} --}}

                </a>
                <a href="{{route('note.index')}}" class="btn btn-info ml-3">
                    <h5>Go to Developing mode</h5>
                </a>
            </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="caption-content">
                       <a href="#" class="iq-user-toggle d-flex align-items-center justify-content-between" id="h-dropdownMenuButton001" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="{{asset('images/user/1.jpg')}}" class="img-fluid rounded avatar-50" alt="user">
                        </a>
