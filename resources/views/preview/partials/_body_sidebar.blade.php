...
<div class="iq-sidebar sidebar-default">
    ...
    <div class="sidebar-caption dropdown">
        ...
        <div class="dropdown-menu w-100 border-0 my-2" aria-labelledby="dropdownMenuButton">
            <a class="dropdown-item mb-2" href="{{route('app.userdetail.userprofile')}}">
                <i class="lar la-user-circle font-size-20 mr-1"></i>
                <span class="mt-2">My Profile</span>
            </a>
            <a class="dropdown-item mb-2" href="{{ route('app.userdetail.profileedit') }}">
                <i class="las la-user-edit font-size-20 mr-1"></i>
                <span>Edit Profile</span>
            </a>
            <a class="dropdown-item mb-2" href="{{ route('app.userdetail.accountsetting') }}">
                <i class="las la-user-cog font-size-20 mr-1"></i>
                <span>Account Settings</span>
            </a>
            <a class="dropdown-item mb-3" href="{{ route('app.userdetail.privacysetting') }}">
            ...
            <hr class="my-2">
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <a href="javascript:void(0)" class="dropdown-item" onclick="event.preventDefault(); this.closest('form').submit();">
                        <i class="las la-sign-out-alt font-size-20 mr-1"></i>{{ __('Log out') }}
                    </a>
                </form>
            </a>
        </div>
    ...
    <div class="data-scrollbar" data-scroll="1">
        ...
        <div class="sidebar-btn dropdown mb-3">
            <a href="{{route('note.index')}}" class="btn btn-primary mb-2 position-relative  d-flex align-items-center justify-content-between" style="height: 40px;"><span class="btn-title">Go to Developing Mode</span></a>
            ...
            <div class="dropdown-menu w-100 border-0 py-3" aria-labelledby="dropdownMenuButton01">
                <a class="dropdown-item mb-2" href="{{route('newnotes',['type'=> 'blank'])}}">
                    <span><i class="ri-sticky-note-line mr-3"></i>Blank Notes</span>
                </a>
                <a class="dropdown-item mb-2" href="{{route('newnotes',['type'=> 'todo'])}}">
                    <span><i class="ri-todo-line mr-3"></i>To-do</span>
                </a>
                <a class="dropdown-item mb-2" href="{{route('newnotes',['type'=> 'essay'])}}">
                    <span><i class="ri-booklet-line mr-3"></i>Essay Notes</span>
                </a>
                <a class="dropdown-item" href="{{route('newnotes',['type'=> 'daily'])}}">
        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="{{activeroute('notebooks/*')}}">
                    ...
                    <ul id="notebooks" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="{{activeroute('notebooks/page-project-plans')}}">
                            <a href="{{route('projectplans')}}" class="svg-icon">
                                <i>
                        ...
                        <li class="{{activeroute('notebooks/page-routine-notes')}}">
                            <a href="{{route('projectroutine')}}" class="svg-icon">
                                <i>
                        ...
                        <li class="{{activeroute('notebooks/page-planning')}}">
                            <a href="{{route('planning')}}" class="svg-icon">
                                <i>
                ...
                <li class="{{activeroute('page-reminder')}}">
                    <a href="{{route('reminder')}}" class="svg-icon">
                        <i>
                ...
                <li class="{{activeroute('page-bin')}}">
                    <a href="{{route('bin')}}" class="svg-icon">
                        <i>
                    ...
                    <ul id="otherpage" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li class="{{activeroute('ui/*')}}">
                            ...
                            <ul id="ui" class="iq-submenu collapse" data-parent="#otherpage">
                                    ...
                                    <li class="{{activeRoute('ui/helperclass')}}">
                                            <a href="{{route('ui.helperclass')}}" class="svg-icon">
                                                <i class="">
                        ...
                        <li class="{{activeRoute('auth/*')}}">
                            ...
                            <ul id="auth" class="iq-submenu collapse" data-parent="#otherpage">
                                <li class="">
                                    <a href="{{route('login')}}" class="svg-icon">
                                        <i class="">
                                ...
                                <li class="">
                                    <a href="{{route('register')}}" class="svg-icon">
                                        <i class="">
                        ...
                        <li class="{{activeRoute('pricing/*')}}">
                            ...
                            <ul id="pricing" class="iq-submenu collapse" data-parent="#otherpage">
                                    <li class="{{activeRoute('pricing/pricing1')}}">
                                        <a href="{{route('pricing.pricing1')}}" class="svg-icon">
                                            <i class="">
                                    ...
                                    <li class="{{activeRoute('pricing/pricing2')}}">
                                        <a href="{{route('pricing.pricing2')}}" class="svg-icon">
                                            <i class="">
