                                    ...
                                    <div class="col-md-8">
                                        <form method="POST" action="{{route('note.store')}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" name="description" rows="3" data-change="input" data-custom-target="#note-description" placeholder="Write description ...."></textarea>
                                            </div>
                                            <div class="form-group">
                                                            ...
                                                            <div class="card-header-toolbar d-flex align-items-center">
                                                                ...
                                                                <span class="dropdown-toggle dropdown-bg" id="note-dropdownMenuButton4"
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right"
                                                                        ...
                                                                        <a href="" class="dropdown-item new-note1" data-toggle="modal" data-target="#new-note{{$loop->index}}"><i class="las la-eye mr-3"></i>View</a>
                                                                        <a href="" class="dropdown-item edit-note1" data-toggle="modal" data-target="#edit-note{{$loop->index}}"><i class="las la-pen mr-3"></i>Edit</a>
                                                                        <a href="{{route('note.delete', ['id' => $note->id])}}" onclick="confirm('Are you sure you want to delete this item?');" class="dropdown-item" data-closest-elem=".card"><i class="las la-trash-alt mr-3"></i>Delete</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
{{--                                                                            <a href="#" class="dropdown-item new-note7" data-toggle="modal" data-target="#new-note7"><i class="las la-eye mr-3"></i>View tggsgsg</a>--}}
{{--                                                                            <a href="#" class="dropdown-item edit-note1" data-toggle="modal" data-target="#edit-note1"><i class="las la-pen mr-3"></i>Edit</a>--}}
{{--                                                                            <a class="dropdown-item" data-extra-toggle="delete" data-closest-elem=".card" href="#"><i class="las la-trash-alt mr-3"></i>Delete</a>--}}
{{--                                                                        </div>--}}
{{--                                                                    </div>--}}
                            ...
                            <div class="content create-workform mb-4">
                                <ul class="row mb-0 p-0 list-inline flex-wrap align-items-center">
                                    <li class="col-md-4 mb-4">
                                        <a href="#">
                                            <img src="{{asset('backend')}}/images/gallery/grid/01.jpg" class="img-fluid rounded avatar-150" alt="">
                                        </a>
                                    </li>
                                    <li class="col-md-4 mb-4">
                                        <a href="#">
                                            <img src="{{asset('backend')}}/images/gallery/grid/02.jpg" class="img-fluid rounded avatar-150" alt="">
                                        </a>
                                    </li>
                                    <li class="col-md-4 mb-4">
                                        <a href="#">
                                            <img src="{{asset('backend')}}/images/gallery/grid/03.jpg" class="img-fluid rounded avatar-150" alt="">
                                        </a>
                                    </li>
                                    <li class="col-md-4">
                                        <a href="#">
                                            <img src="{{asset('backend')}}/images/gallery/grid/04.jpg" class="img-fluid rounded avatar-150" alt="">
                                        </a>
                                    </li>
                                    <li class="col-md-4">
                                        <a href="#">
                                            <img src="{{asset('backend')}}/images/gallery/grid/05.jpg" class="img-fluid rounded avatar-150" alt="">
                                        </a>
                                    </li>
                                    <li class="col-md-4">
                                        <a href="#">
                                            <img src="{{asset('backend')}}/images/gallery/grid/06.jpg" class="img-fluid rounded avatar-150" alt="">
                                        </a>
                                    </li>
                                </ul>
                            </div>
