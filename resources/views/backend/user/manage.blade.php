                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">User List {{Session::get('message')}}</h4>
                            </div>
                        </div>
                        <div class="card-body">
...
{{--                                        <th>Status</th>--}}
                                    ...
                                    <tr>
                                        <td>{{$loop->index+1}}</td>
                                        <td class="text-center"><img class="rounded img-fluid avatar-40" src="{{asset($user->image)}}" alt="{{$user->first_name}}"></td>
